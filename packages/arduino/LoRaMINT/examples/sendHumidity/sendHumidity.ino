/***************************************************************************
  ...
  humidity, temperature & pressure sensor. It measures the humidity and 
...
void setup() {
    ...
    Serial.println("-- Send Humidity Example --");
}
...
void loop() { 
  ...
  MintValue value = MintValue(humidity,"% rel","Ort","Luftfeutigkeit","BME 280");
